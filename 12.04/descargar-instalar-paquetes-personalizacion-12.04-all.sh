...
#sudo apt-get install arc-theme papirus-icon-theme -y
...
#sudo apt-get update
#sudo apt-get install yaru-theme-gnome-shell yaru-theme-icon yaru-theme-unity yaru-theme-gtk yaru-theme-sound -y

#wallpapers
#sudo apt-get install ubuntu-wallpapers-bionic -y