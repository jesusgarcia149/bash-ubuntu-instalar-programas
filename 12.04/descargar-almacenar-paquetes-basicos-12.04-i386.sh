...
sudo mkdir $DIRECTORIO/6.-utilidades/neofetch
sudo cp /var/cache/apt/archives/* $DIRECTORIO/6.-utilidades/neofetch
sudo apt-get clean
...
sudo cp megasync_4.2.5+1.1_i386.deb $DIRECTORIO/7.-descargas/megasync
sudo apt-get clean
